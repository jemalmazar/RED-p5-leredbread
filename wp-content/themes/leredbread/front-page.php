					...
					<ul>
						...
						<li>
							...
							<div class="review-content">
								...
								<p class="reviewer-info">
									Chef -
									<a href="#">Sailor Spoon</a>
								</p>
							</div>
						</li>
						<li>
							<img src="<?php echo get_template_directory_uri(); ?>/images/testimonial-headshots/ana-vandana-headshot.png" alt="Ana Vandana headshot"/>
							<div class="review-content">
								...
								<p class="reviewer-info">
									Author -
									<a href="#">Food is Great Magazine</a>
								</p>
							</div>
						</li>
						<li>
